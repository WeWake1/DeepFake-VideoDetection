"""
Face Detector for DFD (Google/Jigsaw) Dataset
Detects and aligns faces from DFD frames using GPU-accelerated MTCNN

Processes both folders:
- original_videos/ (real)
- manipulated_videos/ (fake)
"""
import os
import cv2
import numpy as np
...
def process_video_folder(video_folder, output_base, folder_name, detector, writer, stats):
    ...
    # Output: H:\DFD\faces\<folder_name>\<video_name>\
...
def main():
    """Main face detection logic for DFD"""
    print("="*70)
